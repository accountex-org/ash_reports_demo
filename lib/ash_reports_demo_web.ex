defmodule AshReportsDemoWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: AshReportsDemoWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {AshReportsDemoWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import AshReportsDemoWeb.CoreComponents
      import AshReportsDemoWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: AshReportsDemoWeb.Router,
        statics: AshReportsDemoWeb.static_paths()
    end
  end
